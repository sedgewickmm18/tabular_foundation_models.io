...
<span>Minimizing the Negative Log-Likelihood (NLL) is equivalent to minimizing the KL Divergence because they differ only by a constant value: the entropy of the true distribution.</span>

<div style="text-align: center; margin: 1em 0;">
<img src="assets/images/math/kl_divergence.svg" alt="KL Divergence Formula" style="max-width: 40%;">
</div>

<span>with D<sub>KL</sub> denoting the K-L divergence, a measure of how close distributions are, H(p, q) the cross-entropy H(p, q), i.e. the NLL, and H(p) the entropy of the data generating process, i.e. the task.
H(p) indicates how "noisy" the task is; it's independent of the training process which focuses on learning cross entropy.
</span>
...
<div style="text-align: center; margin: 1em 0;">
<img src="assets/images/math/training_objective_tasks.svg" alt="Training Objective" style="max-width: 50%;">
</div>
...
<div style="text-align: center; margin: 1em 0;">
<img src="assets/images/math/posterior_predictive_marginalized.svg" alt="Posterior Predictive Distribution" style="max-width: 50%;">
</div>
